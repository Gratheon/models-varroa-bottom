...
# Keep runtime lean:
# - force CPU-only torch wheels when available (avoids CUDA dependency bloat)
# - install ultralytics without optional deps not needed for inference
RUN set -eux; \
